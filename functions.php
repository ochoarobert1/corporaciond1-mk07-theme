...
load_theme_textdomain( 'corporaciond1', get_template_directory() . '/languages' );
...
register_nav_menus( array(
    'header_menu' => __( 'Menu Header - Principal', 'corporaciond1' ),
    'footer_menu' => __( 'Menu Footer - Principal', 'corporaciond1' ),
) );
...
add_action( 'widgets_init', 'corporaciond1_widgets_init' );
function corporaciond1_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Sidebar Principal', 'corporaciond1' ),
        'id' => 'main_sidebar',
        'description' => __( 'Estos widgets seran vistos en las entradas y páginas del sitio', 'corporaciond1' ),
...
function dashboard_footer() {
    ...
    _e ('Gracias por crear con ', 'corporaciond1' );
    echo '<a href="http://wordpress.org/" target="_blank">WordPress.</a> - ';
    _e ('Tema desarrollado por ', 'corporaciond1' );
    echo '<a href="http://robertochoa.com.ve/?utm_source=footer_admin&utm_medium=link&utm_content=corporaciond1" target="_blank">Robert Ochoa</a></span>';
}
